...
import { Eye, EyeOff, UserCog, AlertCircle } from "lucide-react";
...
export default function EmployeePortalLoginPage() {
  const { employee, loading, login } = useEmployeePortalAuth();
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      ...
      >
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">Motors Mitra — sign in to mark your attendance</p>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-gray-400">
          Don&apos;t have a login yet? Ask your manager for your email and password.
        </p>
      </form>
    </div>
  );
